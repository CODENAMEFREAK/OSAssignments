...
_print32:
	...
	mov ecx,[ebp+12] 			;Second argument to ecx. taking argument message. Since stack grows downward and arguments are at constant offsets away from the base pointer value.
	mov edx,[ebp+8] 			;Third argument to edx.taking argument length and arguments are at constant offsets away from the base pointer value.
	
	mov eax,SYS_WRITE			;SYS_CALL number is moved to eax
	mov ebx,STDOUT				;Output stream is moved to ebx i.e. first argument to systemcall.
